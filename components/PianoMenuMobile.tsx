...
<Link href="/"> 
        ...
        <h3 className="text-2xl font-bold rounded-xl border-black  border p-6 text-right hover:text-teal-600 focus:text-blue-600 bg-white  shadow-md hover:bg-gray-50">
          <Link href="/about">
            <a className="font-thin text-3xl">About &rarr;</a>
          </Link>
          <div className="h-12 w-1/3 bg-black absolute top-60% left-0 md:left-40 rounded-md"></div>
        </h3>

        <h3 className="text-2xl font-bold rounded-xl border-black  border p-6 text-right hover:text-teal-600 focus:text-blue-600 bg-white  shadow-md hover:bg-gray-50">
          <Link href="/works">
            <a className="font-thin text-3xl">Works &rarr;</a>
          </Link>
          <div className="h-12 w-1/3 bg-black absolute top-100 left-0 md:left-40 rounded-md"></div>
        </h3>

        <h3 className="text-2xl font-bold rounded-xl border-black  border p-6 text-right hover:text-teal-600 focus:text-blue-600 bg-white  shadow-md hover:bg-gray-50">
          <Link href="/education">
            <a className="font-thin text-3xl">Education &rarr;</a>
          </Link>
          <div className="h-12 w-1/3 bg-black  absolute top-100 left-0 md:left-40 rounded-md"></div>
        </h3>
        ...
        <h3 className="text-2xl font-bold rounded-xl border-black  border p-6 text-right hover:text-teal-600 focus:text-blue-600 bg-white  shadow-md hover:bg-gray-50">
          <Link href="/production-services">
            <a className="font-thin text-3xl">Production Services &rarr;</a>
          </Link>
        </h3>

        <h3 className="text-2xl font-bold rounded-xl border-black border p-6 text-right hover:text-teal-600 focus:text-blue-600 bg-white  shadow-md hover:bg-gray-50">
          <Link href="/mixing-mastering">
            <a className="font-thin text-3xl">Mixing & Mastering &rarr;</a>
          </Link>
          <div className="h-12 w-1/3 bg-black  absolute top-100 left-0 md:left-40 rounded-md"></div>
        </h3>
