    ...
    <>
      <div className="flex min-h-screen flex-col items-center justify-begin bg-slate-100">
        ...
        <p className="mx-5 mt-5 max-w-2xl">
          ...
          Percussionist and Trumpeter. The man eats breathes and sleeps music,
          and produces faster than most. "Speed in the studio allows more ideas
          to surface, and having more ideas allows you to choose the best ones
          for the project" -Justin Weisberg Aside from creating music for
          clients, Justin is a skilled and patient teacher, with several you
          tube videos out centered on music production, and courses coming soon.
          Also available for 1 on 1 music lessons
        </p>
      </div>
      <Footer />
    </>
